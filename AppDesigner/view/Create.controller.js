 ...
 */
sap.ui.controller("untitledproject.view.Create", {
	 ...
	 */
	onInit : function() {
		this.byId("pageCreateFrom").bindProperty("value", {path: "create>/from", formatter: untitledproject.util.Types.DATE});
		this.byId("pageCreateTo").bindProperty("value", {path: "create>/to", formatter: untitledproject.util.Types.DATE});
	},
	...
	onCreate: function() {
		...
		oData.from = untitledproject.util.Types.DATE.formatValue(this._getDates().from, "string");
		oData.to = untitledproject.util.Types.DATE.formatValue(this._getDates().to, "string");
